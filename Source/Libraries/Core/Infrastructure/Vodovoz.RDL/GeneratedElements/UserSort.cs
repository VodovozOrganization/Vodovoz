...
namespace Vodovoz.RDL.Elements
{
	...
	public partial class UserSort
	{
		...
		private List<ItemsChoiceType13> itemsElementNameField = new List<ItemsChoiceType13>();
		...
		[XmlIgnore()]
		public List<ItemsChoiceType13> ItemsElementNameList
		{
		...
		public ItemsChoiceType13[] ItemsElementName
		{
			...
			set => ItemsElementNameList = value == null ? new List<ItemsChoiceType13>() : value.ToList();
		}

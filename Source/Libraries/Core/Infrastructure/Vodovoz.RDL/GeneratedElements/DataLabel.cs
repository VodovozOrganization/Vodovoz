...
namespace Vodovoz.RDL.Elements
{
	...
	public partial class DataLabel
	{
		...
		private List<ItemsChoiceType23> itemsElementNameField = new List<ItemsChoiceType23>();
		...
		[XmlIgnore()]
		public List<ItemsChoiceType23> ItemsElementNameList
		{
		...
		public ItemsChoiceType23[] ItemsElementName
		{
			...
			set => ItemsElementNameList = value == null ? new List<ItemsChoiceType23>() : value.ToList();
		}

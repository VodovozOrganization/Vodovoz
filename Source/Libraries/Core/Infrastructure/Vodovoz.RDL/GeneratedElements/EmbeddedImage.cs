...
namespace Vodovoz.RDL.Elements
{
	...
	public partial class EmbeddedImage
	{
		...
		private List<ItemsChoiceType35> itemsElementNameField = new List<ItemsChoiceType35>();
		...
		[XmlIgnore()]
		public List<ItemsChoiceType35> ItemsElementNameList
		{
		...
		public ItemsChoiceType35[] ItemsElementName
		{
			...
			set => ItemsElementNameList = value == null ? new List<ItemsChoiceType35>() : value.ToList();
		}

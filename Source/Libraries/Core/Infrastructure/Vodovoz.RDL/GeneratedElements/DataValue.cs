...
namespace Vodovoz.RDL.Elements
{
	...
	public partial class DataValue
	{
		...
		private List<ItemsChoiceType22> itemsElementNameField = new List<ItemsChoiceType22>();
		...
		[XmlIgnore()]
		public List<ItemsChoiceType22> ItemsElementNameList
		{
		...
		public ItemsChoiceType22[] ItemsElementName
		{
			...
			set => ItemsElementNameList = value == null ? new List<ItemsChoiceType22>() : value.ToList();
		}

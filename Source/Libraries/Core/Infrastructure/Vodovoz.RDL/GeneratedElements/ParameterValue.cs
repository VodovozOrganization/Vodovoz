...
namespace Vodovoz.RDL.Elements
{
	...
	public partial class ParameterValue
	{
		...
		private List<ItemsChoiceType32> itemsElementNameField = new List<ItemsChoiceType32>();
		...
		[XmlIgnore()]
		public List<ItemsChoiceType32> ItemsElementNameList
		{
		...
		public ItemsChoiceType32[] ItemsElementName
		{
			...
			set => ItemsElementNameList = value == null ? new List<ItemsChoiceType32>() : value.ToList();
		}

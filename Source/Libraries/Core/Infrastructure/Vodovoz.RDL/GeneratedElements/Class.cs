...
namespace Vodovoz.RDL.Elements
{
	...
	public partial class Class
	{
		...
		private List<ItemsChoiceType36> itemsElementNameField = new List<ItemsChoiceType36>();
		...
		[XmlIgnore()]
		public List<ItemsChoiceType36> ItemsElementNameList
		{
		...
		public ItemsChoiceType36[] ItemsElementName
		{
			...
			set => ItemsElementNameList = value == null ? new List<ItemsChoiceType36>() : value.ToList();
		}

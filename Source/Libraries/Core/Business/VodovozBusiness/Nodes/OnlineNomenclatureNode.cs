...
namespace Vodovoz.Nodes
{
	...
	public class OnlineNomenclatureNode
	{
		...
		/// <summary>
		/// Тип установки оборудования <see cref="Vodovoz.Domain.Goods.EquipmentInstallationType"/>
		/// </summary>
		public EquipmentInstallationType? EquipmentInstallationType { get; set; }
		/// <summary>
		/// Способ загрузки <see cref="Vodovoz.Domain.Goods.EquipmentWorkloadType"/>
		/// </summary>
		public EquipmentWorkloadType? EquipmentWorkloadType { get; set; }
		/// <summary>
		/// Тип помпы <see cref="Vodovoz.Domain.Goods.PumpType"/>
		/// </summary>
		public PumpType? PumpType { get; set; }
		/// <summary>
		/// Тип крепления стаканодержателя <see cref="Vodovoz.Domain.Goods.CupHolderBracingType"/>
		/// </summary>
		...
		/// <summary>
		/// Защита на кране с горячей водой <see cref="Vodovoz.Domain.Goods.ProtectionOnHotWaterTap"/>
		/// </summary>
		...
		/// <summary>
		/// Тип охлаждения <see cref="Vodovoz.Domain.Goods.CoolingType"/>
		/// </summary>
		public CoolingType? CoolingType { get; set; }
		/// <summary>
		/// Шкафчик/Холодильник <see cref="Vodovoz.Domain.Goods.LockerRefrigeratorType"/>
		/// </summary>
		...
		/// <summary>
		/// Тип кранов <see cref="Vodovoz.Domain.Goods.TapType"/>
		/// </summary>
		public TapType? TapType { get; set; }
		/// <summary>
		/// Тип стаканодержателя <see cref="Vodovoz.Domain.Goods.GlassHolderType"/>
		/// </summary>
		...
		/// <summary>
		/// Единицы мощности нагрева <see cref="Vodovoz.Domain.Goods.PowerUnits"/>
		/// </summary>
		public PowerUnits? HeatingPowerUnits { get; set; }
		/// <summary>
		/// Единицы мощности охлаждения <see cref="Vodovoz.Domain.Goods.PowerUnits"/>
		/// </summary>
		public PowerUnits? CoolingPowerUnits { get; set; }
		/// <summary>
		/// Единицы производительности нагрева <see cref="Vodovoz.Domain.Goods.ProductivityUnits"/>
		/// </summary>
		public ProductivityUnits? HeatingProductivityUnits { get; set; }
		/// <summary>
		/// Единицы производительности охлаждения <see cref="Vodovoz.Domain.Goods.ProductivityUnits"/>
		/// </summary>
		public ProductivityUnits? CoolingProductivityUnits { get; set; }
		/// <summary>
		/// Показатель производительности нагрева <see cref="Vodovoz.Domain.Goods.ProductivityComparisionSign"/>
		/// </summary>
		public ProductivityComparisionSign? HeatingProductivityComparisionSign { get; set; }
		/// <summary>
		/// Показатель производительности охлаждения <see cref="Vodovoz.Domain.Goods.ProductivityComparisionSign"/>
		/// </summary>

	...
	public static class Configure
	{
		...
		public static void ConfigureDeletion()
		{
			...
			DeleteConfig.AddHibernateDeleteInfo<Employee>()
				...
				.AddClearDependence<CarLoadDocument>(item => item.AuthorId)
				.AddClearDependence<CarLoadDocument>(item => item.LastEditorId)
				.AddClearDependence<CarUnloadDocument>(x => x.AuthorId)
				.AddClearDependence<CarUnloadDocument>(x => x.LastEditorId)
				.AddClearDependence<IncomingInvoice>(x => x.AuthorId)
				.AddClearDependence<IncomingInvoice>(x => x.LastEditorId)
				.AddClearDependence<IncomingWater>(x => x.AuthorId)
				.AddClearDependence<IncomingWater>(x => x.LastEditorId)
				.AddClearDependence<MovementDocument>(x => x.AuthorId)
				.AddClearDependence<MovementDocument>(x => x.LastEditorId)
				.AddClearDependence<WriteOffDocument>(x => x.AuthorId)
				.AddClearDependence<WriteOffDocument>(x => x.LastEditorId)
				.AddClearDependence<InventoryDocument>(x => x.AuthorId)
				.AddClearDependence<InventoryDocument>(x => x.LastEditorId)
				.AddClearDependence<RegradingOfGoodsDocument>(x => x.AuthorId)
				.AddClearDependence<RegradingOfGoodsDocument>(x => x.LastEditorId)
				.AddClearDependence<SelfDeliveryDocument>(x => x.AuthorId)
				.AddClearDependence<SelfDeliveryDocument>(x => x.LastEditorId)

	...
	public class EdoContainerSpecification : ExpressionSpecification<EdoContainer>
	{
		...
		public static ExpressionSpecification<EdoContainer> CreateForOrganizationId(int organizationId)
			=> CreateForOrderContractOrganizationId(organizationId)
				.Or(CreateForOrderWithoutShipmentForAdvancePaymentOrganizationId(organizationId))
				.Or(CreateForOrderWithoutShipmentForDebtOrganizationId(organizationId))
				.Or(CreateForOrderWithoutShipmentForPaymentOrganizationId(organizationId));
		...
		public static ExpressionSpecification<EdoContainer> CreateForOrderWithoutShipmentForAdvancePaymentOrganizationId(int organizationId)
			=> new EdoContainerSpecification(x => x.OrderWithoutShipmentForAdvancePayment.Order.Contract.Organization.Id == organizationId);

		public static ExpressionSpecification<EdoContainer> CreateForOrderWithoutShipmentForDebtOrganizationId(int organizationId)
			=> new EdoContainerSpecification(x => x.OrderWithoutShipmentForDebt.Order.Contract.Organization.Id == organizationId);

		public static ExpressionSpecification<EdoContainer> CreateForOrderWithoutShipmentForPaymentOrganizationId(int organizationId)
			=> new EdoContainerSpecification(x => x.OrderWithoutShipmentForPayment.Order.Contract.Organization.Id == organizationId);

...
namespace Vodovoz.Core.Domain.Payments
{
	...
	public class PaymentEntity : PropertyChangedBase, IDomainObject
	{
		...
		private IObservableList<PaymentItemEntity> _paymentItems = new ObservableList<PaymentItemEntity>();

		public PaymentEntity() { }

		public PaymentEntity(TransferDocument doc, OrganizationEntity org, CounterpartyEntity counterparty)
		{
		...
		public virtual IObservableList<PaymentItemEntity> PaymentItems
		{
			get => _paymentItems;

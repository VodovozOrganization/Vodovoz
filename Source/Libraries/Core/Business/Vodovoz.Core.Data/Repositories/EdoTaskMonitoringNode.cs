...
namespace Vodovoz.Core.Data.Repositories
{
	...
	public class EdoTaskMonitoringNode : IEdoDocflowMonitoringNode
	{
		...
		/// Заполняется при выборке по кодам задач; при выборке незавершенных задач
		/// для регистрации отклонений всегда ложь, такие задачи из выборки исключаются
		/// </summary>
		public bool IsFinished { get; set; }

		/// <summary>
		/// Признак наличия активной зарегистрированной проблемы по задаче.
		/// Заполняется при выборке по кодам задач; при выборке задач для регистрации
		/// отклонений всегда ложь, такие задачи из выборки исключаются
		/// </summary>

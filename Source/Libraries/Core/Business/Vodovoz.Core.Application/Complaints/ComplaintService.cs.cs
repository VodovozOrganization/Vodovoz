...
namespace Vodovoz.Core.Application.Complaints
{
	public class ComplaintService : IComplaintService
	{
		...
		{
			var canCreateDuplicateComplaints = _currentPermissionService.ValidatePresetPermission(Domain.Permissions.ComplaintPermissions.CanCreateDuplicateComplaints);

...
{
	public class YandexPayApiClient : IYandexPayApiClient
	{
		private readonly HttpClient _httpClient;
		private readonly ILogger<YandexPayApiClient> _logger;
		private readonly JsonSerializerOptions _jsonOptions;

		public YandexPayApiClient(
			HttpClient httpClient,
			ILogger<YandexPayApiClient> logger,

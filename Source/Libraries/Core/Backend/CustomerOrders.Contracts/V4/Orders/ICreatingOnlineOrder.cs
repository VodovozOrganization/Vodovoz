...
namespace CustomerOrders.Contracts.V4.Orders
{
	public interface ICreatingOnlineOrder
	{
		...
		/// Форма оплаты
		/// </summary>
		ExternalOrderPaymentType OnlineOrderPaymentType { get; set; }

		/// <summary>
		/// Статус оплаты
		/// </summary>
		ExternalOrderPaymentStatus OnlineOrderPaymentStatus { get; set; }
		...
		/// Источник оплаты
		/// </summary>
		ExternalPaymentSource? OnlinePaymentSource { get; set; }
		...
		/// Список товаров
		/// </summary>
		IList<OnlineOrderItemDtoV4> OnlineOrderItems { get; set; }

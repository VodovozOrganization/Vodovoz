...
namespace WarehouseApi.Library.Extensions
{
	...
	{
		public static OrderItemDto ToApiDto(this OrderItem orderItem, Nomenclature nomenclature)
		{
		...
		public static IEnumerable<OrderItemDto> ToApiDto(this IEnumerable<OrderItem> orderItems, IEnumerable<Nomenclature> nomenclatures)
		{
			...
			return orderItems
				.Select(x => x.ToApiDto(nomenclatures

...
namespace DriverAPI.Library.V5.Services
{
	...
	public interface IRouteListService
	{
		...
		/// <summary>
		/// Получение полной информации о передаче адреса маршрутного листа
		/// </summary>
		/// <param name="routelistAddtessId"></param>
		/// <returns></returns>
		Result<RouteListAddressTransferDto> GetFullTransferInfo(int routelistAddtessId);
	}
}

...
{
	public class DatePickerViewModel : WidgetViewModelBase
	{
		private DateTime _selectedDate;

		private readonly Func<DateTime, bool> _canSelectNextDateFunc;
		private readonly Func<DateTime, bool> _canSelectPreviousDateFunc;
		...
		public string SelectedDateTitle => SelectedDate.ToString("Y");

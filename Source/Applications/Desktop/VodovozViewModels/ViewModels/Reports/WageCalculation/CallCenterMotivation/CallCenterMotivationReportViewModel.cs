	...
	public class CallCenterMotivationReportViewModel : DialogTabViewModelBase
	{
		...
		private void ShowInfo()
		{
			var info = "1. Подсчет отчёта ведется на основе заказов. В отчёте учитываются заказы со статусами:\r\n" +
			           ...
			           "3. Если выводится нулевое значение, то для номенклатуры необходимо заполнить коэффициент мотивации в справочнике:\r\n" +
			           "Справочники - Наша организация - Зарплата - Коэф. мотивации КЦ";

...
namespace Vodovoz.ViewModels.ViewModels.Orders
{
	public sealed class ServiceDistrictsSetViewModel : EntityTabViewModelBase<ServiceDistrictsSet>
	{
			...
			: base(uowBuilder, unitOfWorkFactory, commonServices, navigation)
		{
			...
			CanEditDistrict = districtPermissionResult.CanUpdate && Entity.Status != ServiceDistrictsSetStatus.Active;
			CanEditDeliveryRules = (CanEditDistrict || commonServices.CurrentPermissionService.ValidatePresetPermission("can_edit_delivery_rules")) && Entity.Status != ServiceDistrictsSetStatus.Active;
		...
		private DelegateCommand CreateAddDistrictCommand() =>
			new DelegateCommand(
				() =>
				{
					...
					//Entity.Districts.Add(newDistrict);
		...
		private DelegateCommand CreateRemoveDistrictCommand() =>
			new DelegateCommand(
				() =>
				{
					...
					{
						Entity.Districts.Add(distrToDel);
		...
		{
			var districts = Entity.Districts

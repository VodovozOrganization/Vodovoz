	...
	public class CarViewModel : EntityTabViewModelBase<Car>
	{
			...
			: base(uowBuilder, unitOfWorkFactory, commonServices, navigationManager)
		{
			...
			CanChangeBottlesFromAddress = commonServices.PermissionService.ValidateUserPresetPermission(
				Vodovoz.Core.Domain.Permissions.LogisticPermissions.Car.CanChangeCarsBottlesFromAddress,
				commonServices.UserService.CurrentUserId);

			CanChangeCarModel =
				Entity.Id == 0 || commonServices.CurrentPermissionService.ValidatePresetPermission(Vodovoz.Core.Domain.Permissions.LogisticPermissions.Car.CanChangeCarModel);

...
namespace Vodovoz.ViewModels.Extensions
{
	public static class ViewModelExtensions
	{
		...
		public static U GetIdRefField<T, U>(this ViewModel<T> entityTabViewModelBase, ref U field, int? entityFieldId)
		...
		public static bool SetIdRefField<T, U>(this ViewModel<T> entityTabViewModelBase, SetFieldDelegate<U> setField, ref U targetField, Expression<Func<int?>> targetPropertyExpr, U value)
			where T : class, IDomainObject, INotifyPropertyChanged, new()
			where U : IDomainObject
		{

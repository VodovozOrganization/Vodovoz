...
namespace Vodovoz.Infrastructure.Report.SelectableParametersFilter
{
		...
		where TEntity : class, IDomainObject
	{
		...
		public RecursiveParametersFactory(IUnitOfWork uow, Func<IEnumerable<Func<ICriterion>>, IList<TEntity>> sourceFunc, Func<TEntity, string> titleFunc, Func<TEntity, IList<TEntity>> childsSelector)
		{

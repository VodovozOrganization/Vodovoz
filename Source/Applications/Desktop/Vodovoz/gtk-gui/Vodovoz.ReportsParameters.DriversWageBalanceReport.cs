...
namespace Vodovoz.ReportsParameters
{
	public partial class DriversWageBalanceReport
	{
		...
		protected virtual void Build()
		{
			...
			// Widget Vodovoz.ReportsParameters.DriversWageBalanceReport
			global::Stetic.BinContainer.Attach(this);
			this.Name = "Vodovoz.ReportsParameters.DriversWageBalanceReport";
			// Container child Vodovoz.ReportsParameters.DriversWageBalanceReport.Gtk.Container+ContainerChild
			...
			this.ydateBalanceBefore.HideCalendarButton = false;
			...
			this.ydateDateSolary.HideCalendarButton = false;

...
{
	public partial class TariffZoneView
	{
		...
		private global::Gamma.GtkWidgets.yCheckButton ycheckIsFastDeliveryAvailable;

		protected virtual void Build()
		{
			global::Stetic.Gui.Initialize(this);
			// Widget Vodovoz.Views.Logistic.TariffZoneView
			global::Stetic.BinContainer.Attach(this);
			this.Name = "Vodovoz.Views.Logistic.TariffZoneView";
			// Container child Vodovoz.Views.Logistic.TariffZoneView.Gtk.Container+ContainerChild
			...
			this.label2.LabelProp = global::Mono.Unix.Catalog.GetString("Доступна доставка за час:");
			...
			// Container child datatable1.Gtk.Table+TableChild
			this.ycheckIsFastDeliveryAvailable = new global::Gamma.GtkWidgets.yCheckButton();
			this.ycheckIsFastDeliveryAvailable.CanFocus = true;
			this.ycheckIsFastDeliveryAvailable.Name = "ycheckIsFastDeliveryAvailable";
			this.ycheckIsFastDeliveryAvailable.Label = "";
			this.ycheckIsFastDeliveryAvailable.DrawIndicator = true;
			this.ycheckIsFastDeliveryAvailable.UseUnderline = true;
			this.datatable1.Add(this.ycheckIsFastDeliveryAvailable);
			global::Gtk.Table.TableChild w14 = ((global::Gtk.Table.TableChild)(this.datatable1[this.ycheckIsFastDeliveryAvailable]));

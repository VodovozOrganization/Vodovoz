...
{
	public partial class NonReturnReasonView
	{
		...
		private global::Gamma.GtkWidgets.yCheckButton ycheckbuttonNeedForfeit;
		...
		protected virtual void Build()
		{
			...
			// Widget Vodovoz.Views.Goods.NonReturnReasonView
			global::Stetic.BinContainer.Attach(this);
			this.Name = "Vodovoz.Views.Goods.NonReturnReasonView";
			// Container child Vodovoz.Views.Goods.NonReturnReasonView.Gtk.Container+ContainerChild
			...
			// Container child table1.Gtk.Table+TableChild
			this.ycheckbuttonNeedForfeit = new global::Gamma.GtkWidgets.yCheckButton();
			this.ycheckbuttonNeedForfeit.CanFocus = true;
			this.ycheckbuttonNeedForfeit.Name = "ycheckbuttonNeedForfeit";
			this.ycheckbuttonNeedForfeit.Label = global::Mono.Unix.Catalog.GetString("Необходимо начислять неустойку");
			this.ycheckbuttonNeedForfeit.DrawIndicator = true;
			this.ycheckbuttonNeedForfeit.UseUnderline = true;
			this.table1.Add(this.ycheckbuttonNeedForfeit);
			global::Gtk.Table.TableChild w7 = ((global::Gtk.Table.TableChild)(this.table1[this.ycheckbuttonNeedForfeit]));
			w7.TopAttach = ((uint)(1));

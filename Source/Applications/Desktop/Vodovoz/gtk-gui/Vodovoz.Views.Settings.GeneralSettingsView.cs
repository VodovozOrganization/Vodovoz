...
namespace Vodovoz.Views.Settings
{
	public partial class GeneralSettingsView
	{
		...
		protected virtual void Build()
		{
			...
			this.ycheckWaitUntil.Label = global::Mono.Unix.Catalog.GetString("Разрешить редактирование поля \"Ожидает до\" в заказах");
			...
			this.GtkLabelWaitUntil.LabelProp = global::Mono.Unix.Catalog.GetString("<b>Настройка поля \"Ожидает до\" в заказах</b>");

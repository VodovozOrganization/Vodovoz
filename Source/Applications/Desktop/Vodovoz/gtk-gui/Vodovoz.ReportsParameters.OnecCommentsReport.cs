...
{
	public partial class OnecCommentsReport
	{
		...
		private global::Gtk.VBox vboxSelectableFilter;
		...
		protected virtual void Build()
		{
			...
			// Widget Vodovoz.ReportsParameters.OnecCommentsReport
			global::Stetic.BinContainer.Attach(this);
			this.Name = "Vodovoz.ReportsParameters.OnecCommentsReport";
			// Container child Vodovoz.ReportsParameters.OnecCommentsReport.Gtk.Container+ContainerChild
			...
			w3.Fill = false;
			// Container child vbox1.Gtk.Box+BoxChild
			this.vboxSelectableFilter = new global::Gtk.VBox();
			this.vboxSelectableFilter.Name = "vboxSelectableFilter";
			this.vboxSelectableFilter.Spacing = 6;
			this.vbox1.Add(this.vboxSelectableFilter);
			global::Gtk.Box.BoxChild w4 = ((global::Gtk.Box.BoxChild)(this.vbox1[this.vboxSelectableFilter]));
			w4.Position = 1;
			// Container child vbox1.Gtk.Box+BoxChild

...
namespace Vodovoz.Core.Permissions
{
	public partial class PermissionListView
	{
		...
		protected virtual void Build()
		{
			...
			// Widget Vodovoz.Core.Permissions.PermissionListView
			global::Stetic.BinContainer.Attach(this);
			this.Name = "Vodovoz.Core.Permissions.PermissionListView";
			// Container child Vodovoz.Core.Permissions.PermissionListView.Gtk.Container+ContainerChild

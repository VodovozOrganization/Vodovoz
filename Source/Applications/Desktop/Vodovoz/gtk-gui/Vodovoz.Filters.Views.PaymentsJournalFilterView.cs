...
namespace Vodovoz.Filters.Views
{
	public partial class PaymentsJournalFilterView
	{
		...
		protected virtual void Build()
		{
			...
			this.hboxCounterparty.Add(this.ylabelSortType);
			global::Gtk.Box.BoxChild w12 = ((global::Gtk.Box.BoxChild)(this.hboxCounterparty[this.ylabelSortType]));
			w12.Position = 3;
			w12.Expand = false;
			w12.Fill = false;
			// Container child hboxCounterparty.Gtk.Box+BoxChild
			...
			this.yenumcmbSortType.DefaultFirst = false;
			this.hboxCounterparty.Add(this.yenumcmbSortType);
			global::Gtk.Box.BoxChild w13 = ((global::Gtk.Box.BoxChild)(this.hboxCounterparty[this.yenumcmbSortType]));
			w13.Position = 4;
			w13.Expand = false;
			this.vboxMain.Add(this.hboxCounterparty);
			global::Gtk.Box.BoxChild w14 = ((global::Gtk.Box.BoxChild)(this.vboxMain[this.hboxCounterparty]));
			w14.Position = 1;
			w14.Expand = false;
			w14.Fill = false;

...
{
	public partial class NomenclatureInnerDeliveryPricesView
	{
		private global::Gtk.VBox vboxWidged;

		private global::Gtk.ScrolledWindow GtkScrolledWindow;

		private global::Gamma.GtkWidgets.yTreeView treeViewPrices;
		...
		private global::Gamma.GtkWidgets.yButton buttonChangePrice;
		...
		protected virtual void Build()
		{
			...
			// Widget Vodovoz.Views.Goods.NomenclatureInnerDeliveryPricesView
			global::Stetic.BinContainer.Attach(this);
			this.Name = "Vodovoz.Views.Goods.NomenclatureInnerDeliveryPricesView";
			// Container child Vodovoz.Views.Goods.NomenclatureInnerDeliveryPricesView.Gtk.Container+ContainerChild
			...
			this.treeViewPrices = new global::Gamma.GtkWidgets.yTreeView();
			this.treeViewPrices.CanFocus = true;
			this.treeViewPrices.Name = "treeViewPrices";
			this.GtkScrolledWindow.Add(this.treeViewPrices);
			...
			w4.Expand = false;
			// Container child hboxButtons.Gtk.Box+BoxChild
			this.buttonChangePrice = new global::Gamma.GtkWidgets.yButton();
			this.buttonChangePrice.CanFocus = true;
			this.buttonChangePrice.Name = "buttonChangePrice";
			this.buttonChangePrice.UseUnderline = true;
			this.buttonChangePrice.Label = global::Mono.Unix.Catalog.GetString("Новая стоимость");
			this.hboxButtons.Add(this.buttonChangePrice);
			global::Gtk.Box.BoxChild w5 = ((global::Gtk.Box.BoxChild)(this.hboxButtons[this.buttonChangePrice]));
			w5.Position = 2;
			w5.Expand = false;
			w5.Fill = false;
			// Container child hboxButtons.Gtk.Box+BoxChild

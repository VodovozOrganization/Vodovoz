...
namespace Vodovoz
{
	public partial class ReadyForReceptionFilter
	{
		...
		protected virtual void Build()
		{
			...
			global::Gtk.Box.BoxChild w1 = ((global::Gtk.Box.BoxChild)(this.yhbox2[this.lblDate]));
			w1.Position = 0;
			w1.Expand = false;
			w1.Fill = false;
			// Container child yhbox2.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w2 = ((global::Gtk.Box.BoxChild)(this.yhbox2[this.daterangepicker]));
			w2.Position = 1;
			w2.Expand = false;
			w2.Fill = false;
			this.yvbox1.Add(this.yhbox2);
			global::Gtk.Box.BoxChild w3 = ((global::Gtk.Box.BoxChild)(this.yvbox1[this.yhbox2]));
			w3.Position = 0;
			w3.Expand = false;
			w3.Fill = false;
			// Container child yvbox1.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w5 = ((global::Gtk.Box.BoxChild)(this.hbox2[this.entityentryWarehouse]));
			w5.Position = 0;
			w5.Expand = false;
			// Container child hbox2.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w6 = ((global::Gtk.Box.BoxChild)(this.hbox2[this.checkWithoutUnload]));
			w6.Position = 1;
			this.hbox3.Add(this.hbox2);
			global::Gtk.Box.BoxChild w7 = ((global::Gtk.Box.BoxChild)(this.hbox3[this.hbox2]));
			w7.Position = 1;
			this.yvbox1.Add(this.hbox3);
			global::Gtk.Box.BoxChild w8 = ((global::Gtk.Box.BoxChild)(this.yvbox1[this.hbox3]));
			w8.Position = 1;
			w8.Expand = false;
			w8.Fill = false;

...
{
	public partial class DriversToDistrictsAssignmentReport
	{
		...
		private global::Gamma.GtkWidgets.yCheckButton onlyDifferentDistricts;
		...
		protected virtual void Build()
		{
			...
			// Widget Vodovoz.ReportsParameters.DriversToDistrictsAssignmentReport
			global::Stetic.BinContainer.Attach(this);
			this.Name = "Vodovoz.ReportsParameters.DriversToDistrictsAssignmentReport";
			// Container child Vodovoz.ReportsParameters.DriversToDistrictsAssignmentReport.Gtk.Container+ContainerChild
			...
			w3.Fill = false;
			// Container child vbox1.Gtk.Box+BoxChild
			this.onlyDifferentDistricts = new global::Gamma.GtkWidgets.yCheckButton();
			this.onlyDifferentDistricts.CanFocus = true;
			this.onlyDifferentDistricts.Name = "onlyDifferentDistricts";
			this.onlyDifferentDistricts.Label = global::Mono.Unix.Catalog.GetString("Только не совпадающие районы");
			this.onlyDifferentDistricts.DrawIndicator = true;
			this.onlyDifferentDistricts.UseUnderline = true;
			this.vbox1.Add(this.onlyDifferentDistricts);
			global::Gtk.Box.BoxChild w4 = ((global::Gtk.Box.BoxChild)(this.vbox1[this.onlyDifferentDistricts]));
			w4.Position = 1;
			w4.Expand = false;
			w4.Fill = false;
			// Container child vbox1.Gtk.Box+BoxChild

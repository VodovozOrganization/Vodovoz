...
{
	public partial class MovementWagonView
	{
		...
		private global::Gamma.GtkWidgets.yEntry yentryMovementWagonName;

		protected virtual void Build()
		{
			global::Stetic.Gui.Initialize(this);
			// Widget Vodovoz.Views.Store.MovementWagonView
			global::Stetic.BinContainer.Attach(this);
			this.Name = "Vodovoz.Views.Store.MovementWagonView";
			// Container child Vodovoz.Views.Store.MovementWagonView.Gtk.Container+ContainerChild
			...
			w7.Fill = false;
			// Container child hbox1.Gtk.Box+BoxChild
			this.yentryMovementWagonName = new global::Gamma.GtkWidgets.yEntry();
			this.yentryMovementWagonName.CanFocus = true;
			this.yentryMovementWagonName.Name = "yentryMovementWagonName";
			this.yentryMovementWagonName.IsEditable = true;
			this.yentryMovementWagonName.InvisibleChar = '•';
			this.hbox1.Add(this.yentryMovementWagonName);
			global::Gtk.Box.BoxChild w8 = ((global::Gtk.Box.BoxChild)(this.hbox1[this.yentryMovementWagonName]));
			w8.Position = 1;
			w8.Expand = false;
			w8.Fill = false;

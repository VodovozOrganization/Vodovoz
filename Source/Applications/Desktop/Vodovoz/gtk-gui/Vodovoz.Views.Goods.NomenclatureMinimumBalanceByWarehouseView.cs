...
namespace Vodovoz.Views.Goods
{
	public partial class NomenclatureMinimumBalanceByWarehouseView
	{
		...
		private global::Gamma.GtkWidgets.yButton ybuttonDelere;
		...
		protected virtual void Build()
		{
			...
			w5.Fill = false;
			// Container child yhboxButtons.Gtk.Box+BoxChild
			this.ybuttonDelere = new global::Gamma.GtkWidgets.yButton();
			this.ybuttonDelere.CanFocus = true;
			this.ybuttonDelere.Name = "ybuttonDelere";
			this.ybuttonDelere.UseUnderline = true;
			this.ybuttonDelere.Label = global::Mono.Unix.Catalog.GetString("Удалить");
			global::Gtk.Image w6 = new global::Gtk.Image();
			w6.Pixbuf = global::Stetic.IconLoader.LoadIcon(this, "gtk-delete", global::Gtk.IconSize.Menu);
			this.ybuttonDelere.Image = w6;
			this.yhboxButtons.Add(this.ybuttonDelere);
			global::Gtk.Box.BoxChild w7 = ((global::Gtk.Box.BoxChild)(this.yhboxButtons[this.ybuttonDelere]));
			w7.Position = 2;
			w7.Expand = false;
			w7.Fill = false;
			// Container child yhboxButtons.Gtk.Box+BoxChild
			...
			this.yhboxButtons.Add(this.buttonInfo);
			global::Gtk.Box.BoxChild w9 = ((global::Gtk.Box.BoxChild)(this.yhboxButtons[this.buttonInfo]));
			w9.Position = 4;
			w9.Expand = false;
			w9.Fill = false;
			...
			this.ytreeMinimemBalances = new global::Gamma.GtkWidgets.yTreeView();
			this.ytreeMinimemBalances.CanFocus = true;
			this.ytreeMinimemBalances.Name = "ytreeMinimemBalances";
			this.GtkScrolledWindow.Add(this.ytreeMinimemBalances);

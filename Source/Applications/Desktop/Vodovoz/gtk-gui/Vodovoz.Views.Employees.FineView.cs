...
namespace Vodovoz.Views.Employees
{
	public partial class FineView
	{
		...
		private global::Gamma.Widgets.yEnumComboBox yenumcomboboxFineCategory;
		...
		protected virtual void Build()
		{
			...
			// Container child tableWriteoff.Gtk.Table+TableChild
			this.yenumcomboboxFineCategory = new global::Gamma.Widgets.yEnumComboBox();
			this.yenumcomboboxFineCategory.Name = "yenumcomboboxFineCategory";
			this.yenumcomboboxFineCategory.ShowSpecialStateAll = false;
			this.yenumcomboboxFineCategory.ShowSpecialStateNot = false;
			this.yenumcomboboxFineCategory.UseShortTitle = false;
			this.yenumcomboboxFineCategory.DefaultFirst = false;
			this.tableWriteoff.Add(this.yenumcomboboxFineCategory);
			global::Gtk.Table.TableChild w28 = ((global::Gtk.Table.TableChild)(this.tableWriteoff[this.yenumcomboboxFineCategory]));

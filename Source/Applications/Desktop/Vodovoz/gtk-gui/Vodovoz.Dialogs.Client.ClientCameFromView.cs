...
{
	public partial class ClientCameFromView
	{
		...
		protected virtual void Build()
		{
			...
			// Widget Vodovoz.Dialogs.Client.ClientCameFromView
			global::Stetic.BinContainer.Attach(this);
			this.Name = "Vodovoz.Dialogs.Client.ClientCameFromView";
			// Container child Vodovoz.Dialogs.Client.ClientCameFromView.Gtk.Container+ContainerChild
			...
			this.datatable1.Add(this.yChkIsArchive);
			global::Gtk.Table.TableChild w8 = ((global::Gtk.Table.TableChild)(this.datatable1[this.yChkIsArchive]));
			w8.TopAttach = ((uint)(1));

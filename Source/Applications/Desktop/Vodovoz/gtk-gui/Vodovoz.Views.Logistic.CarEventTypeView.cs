...
namespace Vodovoz.Views.Logistic
{
	public partial class CarEventTypeView
	{
		...
		private global::Gamma.GtkWidgets.yCheckButton ycheckbuttonAreaOfResponsibility;

		private global::Gamma.GtkWidgets.yLabel ylabelDepartment;
		...
		protected virtual void Build()
		{
			...
			this.ycheckbuttonAreaOfResponsibility = new global::Gamma.GtkWidgets.yCheckButton();
			this.ycheckbuttonAreaOfResponsibility.CanFocus = true;
			this.ycheckbuttonAreaOfResponsibility.Name = "ycheckbuttonAreaOfResponsibility";
			this.ycheckbuttonAreaOfResponsibility.Label = global::Mono.Unix.Catalog.GetString("Зона ответственности");
			this.ycheckbuttonAreaOfResponsibility.DrawIndicator = true;
			this.ycheckbuttonAreaOfResponsibility.UseUnderline = true;
			this.yhbox1.Add(this.ycheckbuttonAreaOfResponsibility);
			global::Gtk.Box.BoxChild w14 = ((global::Gtk.Box.BoxChild)(this.yhbox1[this.ycheckbuttonAreaOfResponsibility]));
			w14.Position = 0;
			w14.Expand = false;
			w14.Fill = false;
			// Container child yhbox1.Gtk.Box+BoxChild
			this.ylabelDepartment = new global::Gamma.GtkWidgets.yLabel();
			this.ylabelDepartment.Name = "ylabelDepartment";
			this.ylabelDepartment.LabelProp = global::Mono.Unix.Catalog.GetString("Отдел:");
			this.yhbox1.Add(this.ylabelDepartment);
			global::Gtk.Box.BoxChild w15 = ((global::Gtk.Box.BoxChild)(this.yhbox1[this.ylabelDepartment]));
			w15.Position = 1;
			w15.Expand = false;
			w15.Fill = false;
			// Container child yhbox1.Gtk.Box+BoxChild
			...
			this.yhbox1.Add(this.yenumcomboboxAreaOfResponsibility);
			global::Gtk.Box.BoxChild w16 = ((global::Gtk.Box.BoxChild)(this.yhbox1[this.yenumcomboboxAreaOfResponsibility]));
			w16.Position = 2;
			w16.Expand = false;
			w16.Fill = false;
			this.table1.Add(this.yhbox1);
			global::Gtk.Table.TableChild w17 = ((global::Gtk.Table.TableChild)(this.table1[this.yhbox1]));

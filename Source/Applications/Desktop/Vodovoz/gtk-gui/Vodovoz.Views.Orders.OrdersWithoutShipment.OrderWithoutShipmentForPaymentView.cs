...
namespace Vodovoz.Views.Orders.OrdersWithoutShipment
{
	public partial class OrderWithoutShipmentForPaymentView
	{
		...
		protected virtual void Build()
		{
			...
			this.hbox6.Add(this.ycheckSendBillByEdo);
			global::Gtk.Box.BoxChild w15 = ((global::Gtk.Box.BoxChild)(this.hbox6[this.ycheckSendBillByEdo]));
			w15.Position = 2;
			w15.Expand = false;
			w15.Fill = false;
			...
			global::Gtk.Box.BoxChild w19 = ((global::Gtk.Box.BoxChild)(this.hbox10[this.ylabel13]));
			w19.Position = 0;
			w19.Expand = false;
			w19.Fill = false;
			// Container child hbox10.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w20 = ((global::Gtk.Box.BoxChild)(this.hbox10[this.daterangepickerOrdersDate]));
			w20.Position = 1;
			...
			global::Gtk.Box.BoxChild w22 = ((global::Gtk.Box.BoxChild)(this.hbox9[this.ylabel11]));
			w22.Position = 0;
			w22.Expand = false;
			w22.Fill = false;
			this.vbox2.Add(this.hbox9);
			global::Gtk.Box.BoxChild w23 = ((global::Gtk.Box.BoxChild)(this.vbox2[this.hbox9]));
			w23.Position = 2;
			w23.Expand = false;
			w23.Fill = false;
			// Container child vbox2.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w25 = ((global::Gtk.Box.BoxChild)(this.vbox2[this.GtkScrolledWindow1]));
			w25.Position = 3;
			this.Add(this.vbox2);
			if ((this.Child != null))
			{

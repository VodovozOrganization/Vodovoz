	...
	public partial class GeneralSalaryInfoReport : SingleUoWWidgetBase, IParametersWidget
	{
		...
		private void ShowInfoWindow(object sender, EventArgs e)
		{
			var info = "Сокращения отчета:\n" + 
				...
				"<b>КВ</b>: категория водителя в зависимости от отработанного времени\n" +
				"Логика отображения: Счет стажа начинается от Даты первого МЛ водителя до текущей даты (даты формирования отчета).\nКатегории:\n" +
				"I - стаж до 60 дней ВКЛЮЧИТЕЛЬНО\nII - стаж от 61 до 120 дней ВКЛЮЧИТЕЛЬНО\nIII - стаж от 121 до 365 дней ВКЛЮЧИТЕЛЬНО\nIV - стаж от 366 дней и более\n" +

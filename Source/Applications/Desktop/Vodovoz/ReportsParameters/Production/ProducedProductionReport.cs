...
namespace Vodovoz.ReportsParameters.Production
{
	...
	public partial class ProducedProductionReport : SingleUoWWidgetBase, IParametersWidget
	{
		...
		public ProducedProductionReport(ReportFactory reportFactory, IEntityAutocompleteSelectorFactory nomenclatureSelectorFactory)
		{
			Build();
		...
		private ReportInfo GetReportInfo()
		{
			...
			reportInfo.Identifier = "Production.ProducedProduction";

...
namespace Vodovoz.Filters.GtkViews
{
	...
	public partial class IncomeCategoryJournalFilterView : FilterViewBase<IncomeCategoryJournalFilterViewModel>
	{
		public IncomeCategoryJournalFilterView(IncomeCategoryJournalFilterViewModel journalFilterViewModel) : base(journalFilterViewModel)
		{
			this.Build();
			this.Configure();
		}

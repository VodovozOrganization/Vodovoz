		...
		private void DrawNewRow(Phone newPhone)
		{
			...
			if(hasExternalUsersForThisPhone)
			{
				phoneDataEntry.TooltipText =
					"По этому телефону привязан пользователь ИПЗ. Архивация доступна в карточке клиента при наличии специального права. При сохранении будут удалены связанные пользователи ИПЗ и данные сопоставления.";
			}

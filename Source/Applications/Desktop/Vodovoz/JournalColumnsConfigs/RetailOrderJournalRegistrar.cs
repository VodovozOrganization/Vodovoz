...
{
	internal sealed class RetailOrderJournalRegistrar : ColumnsConfigRegistrarBase<RetailOrderJournalViewModel, RetailOrderJournalNode>
	{
		public override IColumnsConfig Configure(FluentColumnsConfig<RetailOrderJournalNode> config) =>

...
{
	[ToolboxItem(true)]
	public partial class TransferExpenseView : TabViewBase<TransferExpenseViewModel>
	{
		public TransferExpenseView(TransferExpenseViewModel viewModel) : base(viewModel)
		{
			Build();
		...
		private void Initialize()
		{
			...
			ylabelExpenseCategory.Binding
				.AddFuncBinding(ViewModel.Entity, e => ViewModel.FinancialExpenseCategoryNodeInMemoryCacheRepository.GetTitleById(e.ExpenseCategoryId ?? -1), w => w.LabelProp)
				.InitializeFromSource();

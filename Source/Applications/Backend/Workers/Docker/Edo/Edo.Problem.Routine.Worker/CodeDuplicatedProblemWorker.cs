...
namespace Edo.Problem.Routine.Worker
{
	public class CodeDuplicatedProblemWorker : TimerBackgroundServiceBase
	{
		...
		private readonly IOptionsMonitor<CodeDuplicatedProblemWorkerOptions> _options;
		...
		public CodeDuplicatedProblemWorker(
			...
			IOptionsMonitor<CodeDuplicatedProblemWorkerOptions> options,
		...
		protected override async Task DoWork(CancellationToken stoppingToken)
		{
			...
			try
			{
				var minEdoTaskCreationTime = DateTime.Today - _options.CurrentValue.ProblemTimeout;

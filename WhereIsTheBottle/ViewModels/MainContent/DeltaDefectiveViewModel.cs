...
{
	public class DeltaDefectiveViewModel : BottleAnalyticsReportViewModelBase<DeltaDefectiveModel>
	{
		...
		public DeltaDefectiveViewModel(DeltaDefectiveModel model)
			: base(model)
		{
		...
		private string GetHeaderString()
		{
			...
			var baseString = "Дельта - Брак{0}за " + $"{StartDate?.ToString("d")} - {EndDate?.ToString("d")}";

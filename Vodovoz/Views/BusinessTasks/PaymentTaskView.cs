...
namespace Vodovoz.Views.BusinessTasks
{
	...
	public partial class PaymentTaskView : TabViewBase<PaymentTaskViewModel>
	{
		...
		private void Configure()
		{
			...
			//currentPayEntry.Binding.AddBinding(ViewModel.Entity, vm => vm.OrderPositiveSum, w => w.Text, new IntToStringConverter()).InitializeFromSource();
			//lastPaymentsEntry.Binding.AddBinding(ViewModel.Entity, vm => vm.OrderPositiveSum, w => w.Text, new IntToStringConverter()).InitializeFromSource();
			//orderSumEntry.Binding.AddBinding(ViewModel.Entity, vm => vm.OrderPositiveSum, w => w.Text, new IntToStringConverter()).InitializeFromSource();

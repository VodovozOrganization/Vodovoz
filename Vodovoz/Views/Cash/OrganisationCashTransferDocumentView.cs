...
{
    public partial class OrganisationCashTransferDocumentView : TabViewBase<OrganisationCashTransferDocumentViewModel>
    {
        public OrganisationCashTransferDocumentView(OrganisationCashTransferDocumentViewModel viewModel) :
            base(viewModel)
        {
            this.Build();
            Configure();

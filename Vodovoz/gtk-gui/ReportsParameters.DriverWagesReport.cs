...
namespace ReportsParameters
{
	public partial class DriverWagesReport
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget ReportsParameters.DriverWagesReport
			global::Stetic.BinContainer.Attach (this);
			this.Name = "ReportsParameters.DriverWagesReport";
			// Container child ReportsParameters.DriverWagesReport.Gtk.Container+ContainerChild
			...
			this.hbox2.Add (this.yentryreferenceDriver);
			global::Gtk.Box.BoxChild w5 = ((global::Gtk.Box.BoxChild)(this.hbox2 [this.yentryreferenceDriver]));
			w5.Position = 1;

...
public partial class MainWindow
{
	...
	private global::Gtk.Action ActionReferenceMenu;
	...
	protected virtual void Build ()
	{
		...
		this.ActionReferenceMenu = new global::Gtk.Action ("ActionReferenceMenu", global::Mono.Unix.Catalog.GetString ("Справочники"), null, null);
		this.ActionReferenceMenu.ShortLabel = global::Mono.Unix.Catalog.GetString ("Справочники");
		w1.Add (this.ActionReferenceMenu, null);
		...
		this.Action = new global::Gtk.Action ("Action", global::Mono.Unix.Catalog.GetString ("Организации"), null, null);
		this.Action.ShortLabel = global::Mono.Unix.Catalog.GetString ("Организации");
		...
		this.UIManager.AddUiFromString ("<ui><menubar name='menubarMain'><menu name='ActionBaseMenu' action='ActionBaseMenu'><menuitem name='dialogAuthenticationAction' action='dialogAuthenticationAction'/><menuitem name='UsersAction' action='UsersAction'/><separator/><menuitem name='quitAction' action='quitAction'/></menu><menu name='ActionReferenceMenu' action='ActionReferenceMenu'><menuitem name='Action' action='Action'/><menu name='ActionBanksMenu' action='ActionBanksMenu'><menuitem name='ActionBanksRF' action='ActionBanksRF'/></menu></menu><menu name='Action1' action='Action1'><menuitem name='aboutAction' action='aboutAction'/></menu></menubar></ui>");
		...
		this.Action.Activated += new global::System.EventHandler (this.OnActionOrganizationsActivated);

...
public partial class MainWindow
{
	...
	protected virtual void Build ()
	{
		...
		this.ActionColors = new global::Gtk.Action ("ActionColors", global::Mono.Unix.Catalog.GetString ("Цвета"), null, null);
		...
		this.UIManager.AddUiFromString ("<ui><menubar name='menubarMain'><menu name='ActionBaseMenu' action='ActionBaseMenu'><menuitem name='dialogAuthenticationAction' action='dialogAuthenticationAction'/><menuitem name='UsersAction' action='UsersAction'/><separator/><menuitem name='quitAction' action='quitAction'/></menu><menu name='Action' action='Action'><menuitem name='ActionOrg' action='ActionOrg'/><menu name='ActionOrgMenu' action='ActionOrgMenu'><menuitem name='ActionEmploey' action='ActionEmploey'/><menuitem name='ActionNationality' action='ActionNationality'/><menuitem name='ActionCars' action='ActionCars'/></menu><menu name='ActionBanksMenu' action='ActionBanksMenu'><menuitem name='ActionBanksRF' action='ActionBanksRF'/></menu><menuitem name='ActionColors' action='ActionColors'/><menuitem name='ActionUnits' action='ActionUnits'/><menuitem name='ActionManufacturers' action='ActionManufacturers'/><menuitem name='ActionEquipmentTypes' action='ActionEquipmentTypes'/></menu><menu name='Action1' action='Action1'><menuitem name='aboutAction' action='aboutAction'/></menu></menubar></ui>");

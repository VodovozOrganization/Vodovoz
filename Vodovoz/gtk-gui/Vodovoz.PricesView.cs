...
namespace Vodovoz
{
	public partial class PricesView
	{
		...
		private global::Gtk.DataBindings.DataTable datatablePrices;
		...
		protected virtual void Build()
		{
			...
			this.datatablePrices = new global::Gtk.DataBindings.DataTable(((uint)(1)), ((uint)(6)), false);
			this.datatablePrices.Name = "datatablePrices";
			this.datatablePrices.RowSpacing = ((uint)(6));
			this.datatablePrices.ColumnSpacing = ((uint)(6));
			this.datatablePrices.InheritedDataSource = false;
			this.datatablePrices.InheritedBoundaryDataSource = false;
			this.datatablePrices.InheritedDataSource = false;
			this.datatablePrices.InheritedBoundaryDataSource = false;

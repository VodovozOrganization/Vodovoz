...
namespace Vodovoz.Views.Complaints
{
	public partial class ComplaintDiscussionsView
	{
		...
		protected virtual void Build()
		{
			...
			this.vboxWidget.Add(this.notebook2);
			global::Gtk.Box.BoxChild w1 = ((global::Gtk.Box.BoxChild)(this.vboxWidget[this.notebook2]));
			w1.Position = 0;
			w1.Expand = false;
			w1.Fill = false;
			// Container child vboxWidget.Gtk.Box+BoxChild
			...
			w2.Add(this.vboxSubdivisionItems);
			this.scrolledwindow1.Add(w2);
			this.vboxWidget.Add(this.scrolledwindow1);
			global::Gtk.Box.BoxChild w5 = ((global::Gtk.Box.BoxChild)(this.vboxWidget[this.scrolledwindow1]));
			w5.Position = 1;
			// Container child vboxWidget.Gtk.Box+BoxChild
			...
			this.ybuttonAttachSubdivision.Image = w6;
			this.hboxButtons.Add(this.ybuttonAttachSubdivision);
			global::Gtk.Box.BoxChild w7 = ((global::Gtk.Box.BoxChild)(this.hboxButtons[this.ybuttonAttachSubdivision]));
			w7.Position = 2;
			w7.Expand = false;
			w7.Fill = false;

...
namespace Vodovoz
{
	public partial class WriteoffDocumentItemsView
	{
		...
		protected virtual void Build ()
		{
			...
			this.treeItemsList.InheritedDataSource = false;
			this.treeItemsList.InheritedBoundaryDataSource = false;
			this.treeItemsList.ColumnMappings = "{Vodovoz.Domain.Documents.WriteoffDocumentItem} Name[Наименование]; EquipmentString [С/Н оборудования]; CullingCategoryString[Категория выбраковки]; Amount[Количество]<>; CanEditAmount[CanEditAmount];";

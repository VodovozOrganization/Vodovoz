...
{
	public partial class ExpenseCategoryJournalFilterView
	{
		...
		protected virtual void Build()
		{
			...
			// Widget Vodovoz.Filters.GtkViews.ExpenseCategoryJournalFilterView
			global::Stetic.BinContainer.Attach(this);
			this.Name = "Vodovoz.Filters.GtkViews.ExpenseCategoryJournalFilterView";
			// Container child Vodovoz.Filters.GtkViews.ExpenseCategoryJournalFilterView.Gtk.Container+ContainerChild
			...
			this.hbox1.Add(this.isArchiveLabel1);
			global::Gtk.Box.BoxChild w1 = ((global::Gtk.Box.BoxChild)(this.hbox1[this.isArchiveLabel1]));
			w1.Position = 0;
			w1.Expand = false;
			w1.Fill = false;
			// Container child hbox1.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w4 = ((global::Gtk.Box.BoxChild)(this.hbox2[this.isArchiveLabel2]));
			w4.Position = 0;
			w4.Expand = false;
			w4.Fill = false;
			// Container child hbox2.Gtk.Box+BoxChild

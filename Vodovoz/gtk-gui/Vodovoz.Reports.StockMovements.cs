...
namespace Vodovoz.Reports
{
	public partial class StockMovements
	{
		...
		private global::QS.Widgets.GtkUI.EntityViewModelEntry entityVMentryWarehouse;
		...
		protected virtual void Build()
		{
			...
			// Container child table1.Gtk.Table+TableChild
			this.entityVMentryWarehouse = new global::QS.Widgets.GtkUI.EntityViewModelEntry();
			this.entityVMentryWarehouse.Events = ((global::Gdk.EventMask)(256));
			this.entityVMentryWarehouse.Name = "entityVMentryWarehouse";
			this.entityVMentryWarehouse.CanEditReference = false;
			this.table1.Add(this.entityVMentryWarehouse);
			global::Gtk.Table.TableChild w3 = ((global::Gtk.Table.TableChild)(this.table1[this.entityVMentryWarehouse]));
			w3.TopAttach = ((uint)(1));

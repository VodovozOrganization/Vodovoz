...
namespace Vodovoz
{
	public partial class SubdivisionDlg
	{
		...
		private global::Gtk.VBox vboxSubdivision;
		...
		protected virtual void Build()
		{
			...
			this.evmeChief.CanOpenWithoutTabParent = false;
			...
			this.label4.ShowAll();
			// Container child notebook1.Gtk.Notebook+NotebookChild
			this.vboxSubdivision = new global::Gtk.VBox();
			this.vboxSubdivision.Name = "vboxSubdivision";
			this.vboxSubdivision.Spacing = 6;
			this.notebook1.Add(this.vboxSubdivision);
			global::Gtk.Notebook.NotebookChild w16 = ((global::Gtk.Notebook.NotebookChild)(this.notebook1[this.vboxSubdivision]));
			w16.Position = 4;
			// Notebook tab

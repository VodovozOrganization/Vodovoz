...
namespace Vodovoz
{
	public partial class PaidRentPackagesView
	{
		...
		protected virtual void Build ()
		{
			...
			this.treeRentPackages.InheritedDataSource = false;
			this.treeRentPackages.InheritedBoundaryDataSource = false;
			this.treeRentPackages.ColumnMappings = "{Vodovoz.Domain.PaidRentEquipment} PackageName[Пакет]; EquipmentName[Оборудование]; PriceString[Цена аренды (в месяц)]; EquipmentSerial[Серийный номер];";

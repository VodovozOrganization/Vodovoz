...
namespace Vodovoz.Dialogs.Employees
{
	public partial class PremiumDlg
	{
		...
		protected virtual void Build()
		{
			...
			this.evmeAuthor.Sensitive = false;
			this.evmeAuthor.Events = ((global::Gdk.EventMask)(256));
			this.evmeAuthor.Name = "evmeAuthor";
			this.evmeAuthor.CanEditReference = true;
			this.tablePremium.Add(this.evmeAuthor);
			global::Gtk.Table.TableChild w6 = ((global::Gtk.Table.TableChild)(this.tablePremium[this.evmeAuthor]));

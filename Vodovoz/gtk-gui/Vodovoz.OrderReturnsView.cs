...
namespace Vodovoz
{
	public partial class OrderReturnsView
	{
		...
		protected virtual void Build()
		{
			...
			this.hbox1.Add(this.buttonDelivered);
			global::Gtk.Box.BoxChild w1 = ((global::Gtk.Box.BoxChild)(this.hbox1[this.buttonDelivered]));
			w1.Position = 0;
			w1.Expand = false;
			w1.Fill = false;
			// Container child hbox1.Gtk.Box+BoxChild
			...
			this.hbox1.Add(this.buttonNotDelivered);
			global::Gtk.Box.BoxChild w2 = ((global::Gtk.Box.BoxChild)(this.hbox1[this.buttonNotDelivered]));
			w2.Position = 1;
			w2.Expand = false;
			w2.Fill = false;
			// Container child hbox1.Gtk.Box+BoxChild
			...
			this.hbox1.Add(this.buttonDeliveryCanceled);
			global::Gtk.Box.BoxChild w3 = ((global::Gtk.Box.BoxChild)(this.hbox1[this.buttonDeliveryCanceled]));
			w3.Position = 2;
			w3.Expand = false;
			w3.Fill = false;
			...
			this.hbox2.Add(this.labelOnlineOrder);
			global::Gtk.Box.BoxChild w5 = ((global::Gtk.Box.BoxChild)(this.hbox2[this.labelOnlineOrder]));
			w5.Position = 0;
			w5.Expand = false;
			w5.Fill = false;
			// Container child hbox2.Gtk.Box+BoxChild
			...
			this.hbox2.Add(this.entryOnlineOrder);
			global::Gtk.Box.BoxChild w6 = ((global::Gtk.Box.BoxChild)(this.hbox2[this.entryOnlineOrder]));
			w6.Position = 1;
			...
			global::Gtk.Box.BoxChild w8 = ((global::Gtk.Box.BoxChild)(this.hbox4[this.entryTotal]));
			w8.Position = 0;
			w8.Expand = false;
			// Container child hbox4.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w9 = ((global::Gtk.Box.BoxChild)(this.hbox4[this.yenumcomboOrderPayment]));
			w9.Position = 1;
			...
			global::Gtk.Table.TableChild w14 = ((global::Gtk.Table.TableChild)(this.table1[this.referenceClient]));
			...
			global::Gtk.Table.TableChild w15 = ((global::Gtk.Table.TableChild)(this.table1[this.referenceDeliveryPoint]));
			...
			global::Gtk.Box.BoxChild w17 = ((global::Gtk.Box.BoxChild)(this.hboxBottlesByStock[this.labelBottlesTyStockCount]));
			w17.Position = 0;
			w17.Expand = false;
			w17.Fill = false;
			// Container child hboxBottlesByStock.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w18 = ((global::Gtk.Box.BoxChild)(this.hboxBottlesByStock[this.yspinbuttonBottlesByStockCount]));
			w18.Position = 1;
			w18.Expand = false;
			w18.Fill = false;
			// Container child hboxBottlesByStock.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w19 = ((global::Gtk.Box.BoxChild)(this.hboxBottlesByStock[this.labelBottlesTyStockActualCount]));
			w19.Position = 2;
			w19.Expand = false;
			w19.Fill = false;
			// Container child hboxBottlesByStock.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w20 = ((global::Gtk.Box.BoxChild)(this.hboxBottlesByStock[this.yspinbuttonBottlesByStockActualCount]));
			w20.Position = 3;
			w20.Expand = false;
			w20.Fill = false;
			this.vbox1.Add(this.hboxBottlesByStock);
			global::Gtk.Box.BoxChild w21 = ((global::Gtk.Box.BoxChild)(this.vbox1[this.hboxBottlesByStock]));
			w21.Position = 1;
			w21.Expand = false;
			w21.Fill = false;
			// Container child vbox1.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w23 = ((global::Gtk.Box.BoxChild)(this.vbox5[this.GtkScrolledWindow1]));
			w23.Position = 0;
			// Container child vbox5.Gtk.Box+BoxChild
			...
			this.buttonAddOrderItem.Image = w24;
			this.hbox6.Add(this.buttonAddOrderItem);
			global::Gtk.Box.BoxChild w25 = ((global::Gtk.Box.BoxChild)(this.hbox6[this.buttonAddOrderItem]));
			w25.Position = 0;
			w25.Expand = false;
			w25.Fill = false;
			// Container child hbox6.Gtk.Box+BoxChild
			...
			this.buttonDeleteOrderItem.Image = w26;
			this.hbox6.Add(this.buttonDeleteOrderItem);
			global::Gtk.Box.BoxChild w27 = ((global::Gtk.Box.BoxChild)(this.hbox6[this.buttonDeleteOrderItem]));
			w27.Position = 1;
			w27.Expand = false;
			w27.Fill = false;
			this.vbox5.Add(this.hbox6);
			global::Gtk.Box.BoxChild w28 = ((global::Gtk.Box.BoxChild)(this.vbox5[this.hbox6]));
			w28.Position = 1;
			w28.Expand = false;
			w28.Fill = false;
			...
			this.GtkLabel7.LabelProp = global::Mono.Unix.Catalog.GetString("<b>Товары к клиенту</b>");
			...
			this.GtkAlignment5.Add(this.orderEquipmentItemsView);
			this.frame2.Add(this.GtkAlignment5);
			this.GtkLabel9 = new global::Gtk.Label();
			this.GtkLabel9.Name = "GtkLabel9";
			this.GtkLabel9.LabelProp = global::Mono.Unix.Catalog.GetString("<b>Оборудование</b>");
			...
			global::Gtk.Box.BoxChild w36 = ((global::Gtk.Box.BoxChild)(this.vbox3[this.depositrefunditemsview1]));
			w36.Position = 0;
			this.GtkAlignment7.Add(this.vbox3);
			this.frame3.Add(this.GtkAlignment7);
			this.GtkLabel13 = new global::Gtk.Label();
			this.GtkLabel13.Name = "GtkLabel13";
			this.GtkLabel13.LabelProp = global::Mono.Unix.Catalog.GetString("<b>Возврат залогов</b>");
			this.GtkLabel13.UseMarkup = true;
			this.frame3.LabelWidget = this.GtkLabel13;
			this.vbox1.Add(this.frame3);
			global::Gtk.Box.BoxChild w39 = ((global::Gtk.Box.BoxChild)(this.vbox1[this.frame3]));
			w39.Position = 4;
			this.Add(this.vbox1);
			if ((this.Child != null))
			{

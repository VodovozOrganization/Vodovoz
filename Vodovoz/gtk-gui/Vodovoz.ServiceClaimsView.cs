...
namespace Vodovoz
{
	public partial class ServiceClaimsView
	{
		...
		private global::QSOrmProject.OrmTableView tableServiceClaims;
		...
		protected virtual void Build ()
		{
			...
			this.buttonAdd.ItemsEnumName = "Vodovoz.Domain.Service.ServiceClaimTypesForAdding, Vodovoz";
			...
			this.tableServiceClaims = new global::QSOrmProject.OrmTableView ();
			this.tableServiceClaims.CanFocus = true;
			this.tableServiceClaims.Name = "tableServiceClaims";
			this.tableServiceClaims.CursorPointsEveryType = false;
			this.tableServiceClaims.InheritedDataSource = false;
			this.tableServiceClaims.InheritedBoundaryDataSource = false;
			this.tableServiceClaims.InheritedDataSource = false;
			this.tableServiceClaims.InheritedBoundaryDataSource = false;

...
namespace Vodovoz
{
	public partial class OrderDlg
	{
		...
		private global::Gamma.GtkWidgets.yCheckButton ycheckStorageLogic;
		...
		protected virtual void Build()
		{
			...
			// Container child table1.Gtk.Table+TableChild
			this.ycheckStorageLogic = new global::Gamma.GtkWidgets.yCheckButton();
			this.ycheckStorageLogic.CanFocus = true;
			this.ycheckStorageLogic.Name = "ycheckStorageLogic";
			this.ycheckStorageLogic.Label = global::Mono.Unix.Catalog.GetString("Складская логистика");
			this.ycheckStorageLogic.DrawIndicator = true;
			this.ycheckStorageLogic.UseUnderline = true;
			this.table1.Add(this.ycheckStorageLogic);
			global::Gtk.Table.TableChild w68 = ((global::Gtk.Table.TableChild)(this.table1[this.ycheckStorageLogic]));

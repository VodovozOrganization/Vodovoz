...
namespace Vodovoz {
	public partial class StockBalanceFilter {
		...
		protected virtual void Build() {
			...
			// Container child table1.Gtk.Table+TableChild
			this.speccomboStock = new global::Gtk.DataBindings.DataSpecComboBox();
			this.speccomboStock.Name = "speccomboStock";
			this.speccomboStock.InheritedDataSource = false;
			this.speccomboStock.InheritedBoundaryDataSource = false;
			...
			this.Hide();
			this.speccomboStock.ItemSelected += new global::System.EventHandler<QSOrmProject.EnumItemClickedEventArgs>(this.OnSpeccomboStockItemSelected);
		}
	}
}

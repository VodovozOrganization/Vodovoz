...
namespace Vodovoz
{
    public partial class CounterpartyDlg : QS.Dialog.Gtk.EntityDialogBase<Counterparty>, ICounterpartyInfoProvider, ITDICloseControlTab
    {
        ...
        void ConfigureDlg()
        {
            ...
            supplierPricesWidget.ViewModel = new ViewModels.Client.SupplierPricesWidgetViewModel(
                Entity,
                UoW,
                this,
            ...
            ycheckIsArchived.Sensitive =
                ServicesConfig.CommonServices.CurrentPermissionService.ValidatePresetPermission("can_arc_counterparty_and_deliverypoint");
            ...
            if(Entity.IsChainStore) {
                DelayDaysForProviderValue.Binding.AddBinding(Entity, e => e.DelayDaysForProviders, w => w.ValueAsInt)
                    .InitializeFromSource();
            }
            else {
            ...
            bool canEditCounterpartyDetails = UoW.IsNew ||
                ServicesConfig.CommonServices.PermissionService.ValidateUserPresetPermission("can_edit_counterparty_details", userId);
        ...
        public virtual INomenclatureRepository NomenclatureRepository => nomenclatureRepository ?? (nomenclatureRepository = new EntityRepositories.Goods.NomenclatureRepository());
        ...
        void AllOrders_Activated(object sender, EventArgs e)
        {
            ...
            PermissionControlledRepresentationJournal OrdersDialog =
                new PermissionControlledRepresentationJournal(new OrdersVM(filter), buttons) {

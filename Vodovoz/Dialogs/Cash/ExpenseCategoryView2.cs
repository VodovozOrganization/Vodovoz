...
namespace Vodovoz.Dialogs.Cash
{
	...
	public partial class ExpenseCategoryView2 : TabViewBase<ExpenseCategoryViewModel>
	{
		public ExpenseCategoryView2(ExpenseCategoryViewModel viewModel) : base(viewModel)
		{
			this.Build();
			ConfigureDlg();
		}

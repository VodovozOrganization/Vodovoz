		...
		void ConfigureWnd(){
			var ms = new List<object[]> {
				...
				new object[] {
					...
					PointMarker.GetIconPixbuf("red", PointMarkerShape.overdue),
				...
				new object[] {
					...
					PointMarker.GetIconPixbuf("orange", PointMarkerShape.overdue),
				...
				new object[] {
					...
					PointMarker.GetIconPixbuf("green", PointMarkerShape.overdue),
				...
				new object[] {
					...
					PointMarker.GetIconPixbuf("black", PointMarkerShape.overdue),
				...
				new object[] {
					...
					PointMarker.GetIconPixbuf("black_and_red", PointMarkerShape.overdue),
				...
				new object[] {
					...
					PointMarker.GetIconPixbuf("red_stripes", PointMarkerShape.overdue),
				...
				new object[] {
					...
					PointMarker.GetIconPixbuf("yellow_stripes", PointMarkerShape.overdue),
				...
				new object[] {
					...
					PointMarker.GetIconPixbuf("green_stripes", PointMarkerShape.overdue),
				...
				new object[] {
					...
					PointMarker.GetIconPixbuf("grey_stripes", PointMarkerShape.overdue),
			...
			labelOrdersInfo.Text = "Маркеры помеченные звездой - недовозы по вине водителя/отдела вв" +

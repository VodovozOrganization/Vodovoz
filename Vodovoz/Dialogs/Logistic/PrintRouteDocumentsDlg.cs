		...
		public PrintRouteDocumentsDlg()
		{
			...
			ytreeRoutes.ColumnsConfig = FluentColumnsConfig<SelectablePrintDocument>.Create()
				...
				.AddColumn("Автомобиль")
					.AddPixbufRenderer(x => (x.Document as RouteListPrintableDocs).routeList.Car != null && (x.Document as RouteListPrintableDocs).routeList.ActiveCarVersion.IsCompanyCar ? _vodovozCarIcon : null)

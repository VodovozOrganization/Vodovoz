	...
	public partial class HistoryView : QS.Dialog.Gtk.TdiTabBase, ISingleUoWDialog
	{
        ...
        public HistoryView()
		{
			...
			entryObject3.SetNodeAutocompleteSelectorFactory(
				new NodeAutocompleteSelectorFactory<HistoryTraceObjectJournalViewModel>(typeof(HistoryTraceObjectNode), //typeof(HistoryObjectDesc),
			...
			entryProperty.SetNodeAutocompleteSelectorFactory(
				new NodeAutocompleteSelectorFactory<HistoryTracePropertyJournalViewModel>(typeof(HistoryTracePropertyNode), //typeof(HistoryObjectDesc), 

...
namespace Vodovoz.Filters.GtkViews
{
	...
	public partial class ExpenseCategoryJournalFilterView2 : FilterViewBase<ExpenseCategoryJournalFilterViewModel>
	{
		public ExpenseCategoryJournalFilterView2(ExpenseCategoryJournalFilterViewModel journalFilterViewModel) : base(journalFilterViewModel)
		{
			this.Build();
			this.Configure();
		}

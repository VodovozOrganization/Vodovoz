	...
	partial class MainClass
	{
		...
		static void CreateBaseConfig()
		{
			...
			OrmMain.ClassMappingList = new List<IOrmObjectMapping> {
				...
				OrmObjectMapping<Comments>.Create(),
				OrmObjectMapping<CommentsGroups>.Create().Dialog<CommentDlg>().DefaultTableView().SearchColumn("№", x => x.Id.ToString()).SearchColumn("Название", x => x.Name).End(),

	...
	partial class MainClass
	{
		...
		static void ConfigureViewModelWidgetResolver()
		{
			...
			ViewModelWidgetResolver.Instance
				...
				.RegisterWidgetForTabViewModel<IncomeCategoryViewModel, IncomeCategoryView2>()
				.RegisterWidgetForTabViewModel<ExpenseCategoryViewModel, ExpenseCategoryView2>()
			...
			ViewModelWidgetResolver.Instance
				...
				.RegisterWidgetForWidgetViewModel<IncomeCategoryJournalFilterViewModel, IncomeCategoryJournalFilterView2>()
				.RegisterWidgetForWidgetViewModel<ExpenseCategoryJournalFilterViewModel, ExpenseCategoryJournalFilterView2>()

...
public partial class MainWindow : Gtk.Window
{
    ...
    protected void OnActionSalesReportActivated(object sender, EventArgs e)
    {
        tdiMain.OpenTab(
            ...
            () => new QSReport.ReportViewDlg(new Vodovoz.Reports.SalesReport(new EmployeeRepository()))
        );
    }
    ...
    protected void OnActionFirstClientsActivated(object sender, EventArgs e)
    {
        ...
        tdiMain.OpenTab(
            ...
            () => new QSReport.ReportViewDlg(new FirstClientsReport(sectorsSelectorFactory, new OrderRepository()))
	        );
    }

...
namespace FastPaymentsAPI.Library.DTO_s.Responses
{
	public enum ResponseStatus
	{
		...
		Success,
		[Display(Name = "Поле shop_id пусто")] ShopIdIsEmpty,
		...
		InternalSystemError,
		[Display(Name = "Поле ticket пусто")] TicketIsEmpty,
		...
		InvalidXMLRequest,
		[Display(Name = "Пустой XML-запрос.")] XMLRequestIsEmpty,
		...
		InvalidAmountFormat,
		[Display(Name = "Неизвестная ошибка")] UnknownError
	}
}

		...
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					ConcurrencyStamp = table.Column<string>(type: "varchar(2000)", nullable: true)
				},
				constraints: table =>
				{
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					PasswordHash = table.Column<string>(type: "varchar(2000)", nullable: true),
					SecurityStamp = table.Column<string>(type: "varchar(2000)", nullable: true),
					ConcurrencyStamp = table.Column<string>(type: "varchar(2000)", nullable: true),
					PhoneNumber = table.Column<string>(type: "varchar(2000)", nullable: true),
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					ClaimType = table.Column<string>(type: "varchar(2000)", nullable: true),
					ClaimValue = table.Column<string>(type: "varchar(2000)", nullable: true)
				},
				constraints: table =>
				{
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					ProviderDisplayName = table.Column<string>(type: "varchar(2000)", nullable: true),
					UserId = table.Column<string>(type: "varchar(450)", nullable: false)
				},
				constraints: table =>
				{

...
namespace VodovozDeliveryRulesService
{
	public class DeliveryRulesService : IDeliveryRulesService
	{
			...
			SiteNomenclatureNode[] siteNomenclatures)
		{
			...
			fastDeliveryAvailabilityHistory.AddressWithoutDeliveryPoint = await _fiasApiClient.GetAddressByGeoCoderAsync(latitude, longitude, _cancellationTokenSource.Token);

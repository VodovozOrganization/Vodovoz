...
{
	public class ManufacturerCarsJournalFactory : IManufacturerCarsJournalFactory
	{
		public IEntityAutocompleteSelectorFactory CreateManufacturerCarsAutocompleteSelectorFactory(bool multipleSelect = false)
		{

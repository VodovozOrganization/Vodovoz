...
{
	public class RatesLevelWageParameterViewModel : EntityWidgetViewModelBase<RatesLevelWageParameter>
	{
		public event EventHandler LevelChanged;
		public RatesLevelWageParameterViewModel(IUnitOfWork uow, RatesLevelWageParameter entity, bool canEdit, ICommonServices commonServices) : base(entity, commonServices)
		{
			UoW = uow;
			CanEdit = canEdit;
			Configure();

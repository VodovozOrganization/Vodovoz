...
// 								ActiveDistrictsSet.Status = SectorsSetStatus.Draft;
// 								UoW.Save(ActiveDistrictsSet);
// 							}
// 							Entity.Status = SectorsSetStatus.Active;
// 							UoW.Save(Entity);
// 							UoW.Commit();
//
...
// 						
// 						if(ActiveDistrictsSet != null) {
// 							ActiveDistrictsSet.Status = SectorsSetStatus.Active;
// 							UoW.Save(ActiveDistrictsSet);
// 						}
...
// 			var districtPersister = (AbstractEntityPersister)factory.GetClassMetadata(typeof(Sector));
// 			
...
// 			var borderColumn = districtPersister.GetPropertyColumnNames(nameof(Sector.SectorBorder)).First();
// 			var districtsSetColumn = districtPersister.GetPropertyColumnNames(nameof(Sector.DistrictsSet)).First();
//

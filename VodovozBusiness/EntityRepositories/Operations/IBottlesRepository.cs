...
namespace Vodovoz.EntityRepositories.Operations
{
	...
	{
		int GetBottlesAtCounterparty(IUnitOfWork UoW, Counterparty counterparty, DateTime? before);
		int GetBottlesAtDeliveryPoint(IUnitOfWork UoW, DeliveryPoint deliveryPoint, DateTime? before);

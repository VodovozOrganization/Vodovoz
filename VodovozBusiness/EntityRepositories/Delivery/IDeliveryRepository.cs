...
namespace Vodovoz.EntityRepositories.Delivery
{
	public interface IDeliveryRepository
	{
		...
		/// </summary>
		District GetDistrict(IUnitOfWork uow, decimal latitude, decimal longitude);

		/// <summary>
		/// Возвращает список районов в границы которых входят указанные координаты
		/// </summary>
		IEnumerable<District> GetDistricts(IUnitOfWork uow, decimal latitude, decimal longitude);
	}
}

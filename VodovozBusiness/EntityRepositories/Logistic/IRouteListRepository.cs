...
namespace Vodovoz.EntityRepositories.Logistic
{
	public interface IRouteListRepository
	{
		...
		DateTime? GetDateByDriverWorkingDayNumber(IUnitOfWork uow, int driverId, int dayNumber, CarOwnershipType? carOwnershipTypeOfUse = null);
		DateTime? GetLastRouteListDateByDriver(IUnitOfWork uow, int driverId, CarOwnershipType? carOwnershipTypeOfUse = null);
	}
}

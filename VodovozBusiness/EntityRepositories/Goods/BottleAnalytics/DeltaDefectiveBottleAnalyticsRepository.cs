...
{
	public class DeltaDefectiveBottleAnalyticsRepository : IDeltaDefectiveBottleAnalyticsRepository
	{
		public IFutureEnumerable<SummaryNode> GetRegradingToDefectiveBottlesSummaryFuture(IUnitOfWork uow, DateTime startDate,
			DateTime endDate, int[] nomenclatureIds)
		{
			...
			return uow.Session.QueryOver(() => regradingOfGoodsDocumentItemAlias)
				...
				.And(() => !writeoffNomenclatureAlias.IsDefectiveBottle)
		...
		public IFutureEnumerable<DetailedNode> GetRegradingToDefectiveBottlesDetailedFuture(IUnitOfWork uow, DateTime startDate,

...
{
    public class BillWithoutShipmentForDebtDocument : OrderWithoutShipmentForDebt, IPrintableRDLDocument
    {
        #region implemented abstract members of OrderDocument
		public OrderDocumentType Type => OrderDocumentType.Bill;
		#endregion
		...
		public string Name => String.Format($"Счет №{Id}");

		public DateTime? DocumentDate => CreateDate;

...
namespace Vodovoz.Domain.WageCalculation
{
	...
	[HistoryTrace]
	[EntityPermission]
	public class FixedWageParameter : WageParameter
	{
		[Display(Name = "Тип расчёта ЗП")]
		public override WageParameterTypes WageParameterType {
			get => WageParameterTypes.Fixed;
			set { }
		}

		public override string Title => $"{WageParameterType.GetEnumTitle()}, {FixedWageType.GetEnumTitle()} - {RouteListFixedWage.ToShortCurrencyString()}";

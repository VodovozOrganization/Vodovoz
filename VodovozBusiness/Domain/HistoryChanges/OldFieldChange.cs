...
{
	public class OldFieldChange : FieldChangeBase
	{
		#region Конфигурация
		...
		public virtual OldChangedEntity Entity { get; set; }
		...
		private static bool StringCompare(ref OldFieldChange change, string valueOld, string valueNew)
		{
		...
		private static bool EntityCompare(ref OldFieldChange change, object valueOld, object valueNew)
		{
		...
		private static bool DateTimeCompare(ref OldFieldChange change, PropertyInfo info, object valueOld, object valueNew)
		{
		...
		private static bool DecimalCompare(ref OldFieldChange change, PropertyInfo info, object valueOld, object valueNew)
		{
		...
		private static bool IntCompare<TNumber>(ref OldFieldChange change, PropertyInfo info, object valueOld, object valueNew)
		...
		private static bool BooleanCompare(ref OldFieldChange change, PropertyInfo info, object valueOld, object valueNew)
		{
		...
		protected static bool EnumCompare(ref OldFieldChange change, PropertyInfo info, object valueOld, object valueNew)
		{
		...
		public static OldFieldChange CheckChange(int i, PostUpdateEvent ue)
		{
			return CreateChange(ue.State[i], ue.OldState[i], ue.Persister, i);
		}

		public static OldFieldChange CheckChange(int i, PostInsertEvent ie)
		{
			return CreateChange(ie.State[i], null, ie.Persister, i);
		}

		private static OldFieldChange CreateChange(object valueNew, object valueOld, NHibernate.Persister.Entity.IEntityPersister persister, int i)
		{

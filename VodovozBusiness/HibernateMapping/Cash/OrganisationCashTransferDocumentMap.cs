...
{
    public class OrganisationCashTransferDocumentMap: ClassMap<OrganisationCashTransferDocument>
    {
        public OrganisationCashTransferDocumentMap()
        {
            Table("organisation_cash_transfer_documents");

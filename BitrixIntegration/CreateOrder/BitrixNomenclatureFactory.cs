...
namespace BitrixIntegration {
    ...
    public class BitrixNomenclatureFactory
    {
        ...
        public BitrixNomenclatureFactory(INomenclatureParametersProvider nomenclatureParametersProvider, INomenclatureRepository nomenclatureRepository)
        {
